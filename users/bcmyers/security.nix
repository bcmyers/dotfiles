...
}:
{
  services.gpg-agent = {
    ...
    # Personal GPG-agent SSH keygrips. The ThinkPad runbook requires
    # comparing this inventory with restored secret keys and pruning obsolete
    # entries rather than copying unexplained keygrips forward.
    sshKeys = [
