...
cat <<'MESSAGE'
Krfb is ready for an attended COSMIC trial; it has not been started.
...
The private trial profile disables discovery and requires connection approval.
...
echo "Select the monitor in COSMIC's prompt and allow sharing."
